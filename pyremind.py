    ...
    for i in range(size) :
        ...
        if P != 0 :
            ...
            if index[0].size != 0 :
                ...
                print 'There is a problem with pressure %f and temperature %f'%(P,T)
...
def k_correlated_interp_remind3D(k_rmd,k_cont_rmd,k_sca_rmd,k_cloud_rmd,size,P_rmd,P_array,\
                T_rmd,T_array,n_species,fail,rmind,Continuum=False,Molecular=True,Scattering=False,Clouds=False,Kcorr=False) :
...
def k_correlated_interp_remind3D_M(k_rmd,k_cont_rmd,k_sca_rmd,k_cloud_rmd,size,P_rmd,P_array,\
                T_rmd,T_array,Q_rmd,Q_array,n_species,fail,rmind,Continuum=False,Molecular=True,Scattering=False,Clouds=False,Kcorr=False) :
